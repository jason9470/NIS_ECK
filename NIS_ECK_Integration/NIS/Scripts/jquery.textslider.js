...
; (function ($) {
    $.fn.textslider = function (options) {
        ...
        function startSlide() {
            ...
            //showHint($sliderUl.position().top+","+_scrollHeight);
                ...
                function () {
                    switch (_options.direction) {
                        ...
                        case 'scrollUp':
                            ...
                            if (parseFloat(_now) >= parseFloat(division(division($sliderLi.length, _options.scrollNum), 2))) {
                                $sliderUl.css({ top: "0px" });
                            }
                            break;
                        case 'scrollDown':
