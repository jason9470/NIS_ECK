...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		currentText: "現在", // Display text for current month link
	...
	_attachHandlers: function(inst) {
		...
		inst.dpDiv.find("[data-handler]").map(function () {
			var handler = {
				...
				selectDay: function () {
					window["DP_jQuery_" + dpuuid].datepicker._selectDay(id, +this.getAttribute("data-month"), +this.getAttribute("data-year"), $(this).html());
					return false;
				},
