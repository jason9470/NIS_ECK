...
Dim LogFileName1 = "CorpusHide.xml"
...
function AddNewWord(){
	...
	document.all("iframe1").src="DataAdd.aspx?Desc=" + document.all("Desc1").value + "&ErrDesc=" + document.all("Desc2").value + "&DescType=" + strUser;
...
<hr>
<input type="button" value="匯出Excel" onclick="window.open('DataToExcel.aspx','ABC')">
<br><br>
