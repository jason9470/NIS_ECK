...
(function($){
    $.notty = function(settings){
        ...
        hide = $("<div>", {
            click: function() {
                $(this).parent().removeClass("pop").addClass("remove").fadeOut(500).queue(function () {
                    $(this).clearQueue();
                    $(this).remove()
                })
            }
        ...
        notty.fadeIn(1000).prependTo(container);

        if (settings.timeout){
            setTimeout(function(){
                notty.removeClass("pop").addClass("remove").fadeOut(500).queue(function () {
                    $(this).clearQueue();
                    $(this).remove();
                })
            },settings.timeout)
